...
export function ReceiptSuccess({
  ...
  return (
    <div className="panel-card rounded-2xl p-6 text-center">
      ...
      <p className="mt-4 break-all rounded-2xl border border-line bg-[#FAFAFA] px-4 py-3 text-sm font-medium text-muted">
        {url}
      </p>
      ...
      <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:justify-center">
        ...
        <Link
          ...
          className="inline-flex h-11 items-center justify-center gap-2 rounded-[10px] border border-line bg-white px-4 text-sm font-bold text-ink transition hover:bg-[#FAFAFA]"
        >
